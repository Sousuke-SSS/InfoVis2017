function main()
{
    ...
    for ( var i = 0; i < 256; i++ )
    {
        ...
        var B = xMath.max( Math.cos( S * Math.PI ), 0.0 );
    ...
    {
        var id = faces[i];
        var S0 = Math.floor( ((scalars[ id[0] ]-0.1)/(0.8-0.1))*255 );
        var S1 = Math.floor( ((scalars[ id[1] ]-0.1)/(0.8-0.1))*255 );
        var S2 = Math.floor( ((scalars[ id[2] ]-0.1)/(0.8-0.1))*255 );
